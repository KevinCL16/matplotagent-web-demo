...
size = 0.2  # Set the size of each ring
...
for i, year in enumerate(years):
    ...
    current_radius = 1 - i * size
    
    # Plot the ring if radius is positive
    if current_radius > 0:
        wedges, texts, autotexts = ax.pie(market_share, radius=current_radius, colors=ring_colors,
        ...
        ax.text(0, current_radius - size / 2, year, ha='center', va='center', color='black', fontsize=12, fontweight='bold')
